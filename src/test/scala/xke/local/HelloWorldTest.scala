...
//  }
  test("Je veux ajouter une colonne avec la moyen,ne des numéros département par région") {
  ...
  test("Je veux vérifier que je lis un fichier, ajoute une colonne, la renomme, et suavegarde mon fichier en parquet") {
